  ...
  return (
    <div className="homepage-div">
      ...
      <button className="scanner-nav-button7" onClick={onScannerNavButtonClick}>
        <div className="rectangle-div31" />
        <img className="scan-w-icon6" alt="" src="../scan-w6@2x.png" />
        <div className="scanner-div7">Diagnosis</div>
      </button>
      <button
      ...
      >
        <div className="rectangle-div31" />
        <img className="chat-w-icon2" alt="" src="../chat-w@2x.png" />
        <div className="chat-room-div2">Play Game</div>
      </button>
      <button className="profile-nav-button7" onClick={onProfileNavButtonClick}>
        <div className="rectangle-div31" />
        <img className="profile-w-icon6" alt="" src="../profile-w6@2x.png" />
